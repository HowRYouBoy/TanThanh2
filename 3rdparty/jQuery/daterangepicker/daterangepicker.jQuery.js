...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		...
		posY: rangeInput.offset().top + rangeInput.outerHeight(false), // y position
		appendTo: 'body',
		onClose: function(){},
		onOpen: function(){},
		onChange: function(){},
	...
	var lastValue=null,datepickerOptions = {
		onSelect: function() { 
				...
				options.onChange();	
				if(lastValue != rangeA+' '+rangeB)
				{
					lastValue = rangeA+' '+rangeB;
					rangeInput.change();
				}
			},
			defaultDate: +0
	...
	function toggleRP(){
		...
		if(!options.posY){
			rp.parent().css('top', rangeInput.offset().top + rangeInput.height());
		}
			showRP(); 
		}
	}
